...
const getTransporter = async () => {
    ...
    if (gmailUser && gmailPass) {
        return nodemailer.createTransport({
            ...
            family: 4, // Force IPv4 to prevent ENETUNREACH IPv6 routing errors on cloud servers
...
const sendOtpEmail = async (toEmail, otpCode, isPasswordReset = false) => {
    try {
        ...
        console.log(`✅ 4-Digit OTP Email dispatched to [${toEmail}] (Code: ${otpCode}, MessageID: ${info.messageId})`);
